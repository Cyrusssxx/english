...
LETTERS = {
    ...
    'thanks': {
        ...
        'cn_paras': [
            ...
            '具体来说，我真正感激的是以下几件事。我想衷心感谢你在我逗留期间给予的热情接待。最让我感动的是你的耐心与友善，让我有宾至如归的感觉。若没有你慷慨的帮助，我不可能在{{topic}}上取得这样的进步。',
    ...
    'congrats': {
        ...
        'cn_paras': [
            ...
            '更具体地说，你在{{topic}}上的出色表现清楚地展现了你的{{quality}}。就{{topic}}而言，你在{{achievement}}上的成功确实令人钦佩，也颇具鼓舞意义。在很大程度上，这一成功源于你在{{topic}}上持续付出的努力。最后，{{topic}}上的这一成就必将激励你{{next step}}，助你迈向{{goal}}。',
    ...
    'apology': {
        ...
        'cn_paras': [
            ...
            '具体来说，事情经过如下。在此我必须承认，我在{{topic}}上的{{fault}}已经造成了{{impact}}。由于我在{{topic}}方面{{fault}}，你不得不面对{{impact}}，这本不该发生。尽管{{cause}}在一定程度上解释了事情的起因，但主要责任仍在我。',
    ...
    'complaint': {
        'rows': [
            ...
            ['p3#1', 'You are kindly requested to {{expect}} so that {{topic}} can be handled more effectively.', '请你{{expect}}，以便{{topic}}能够得到更为有效的处理。'],
            ['p3#2', 'Thank you for your time and attention, and I look forward to your positive response.', '感谢你抽时间阅读这封信，期待你的回复。'],
        ],
        'cn_paras': [
            ...
            '请你{{expect}}，以便{{topic}}能够得到更为有效的处理。感谢你抽时间阅读这封信，期待你的回复。',
        ],
    },
    'intro': {
        'rows': [
    ...
    'notice': {
        'rows': [
            ...
            ['p2_notice_s3#0', 'Furthermore, the main contents of {{topic}} include {{content1}}, {{content2}} and {{content3}}, all of which are closely related to the theme.', '此外，{{topic}}的主要内容包括{{content1}}、{{content2}}和{{content3}}，都紧扣主题。'],
        ...
        'cn_paras': [
            ...
            '现将本次活动的具体安排通知如下。首先，{{time}}定为{{topic}}的正式时间，届时全体{{audience}}须准时参加。此外，{{topic}}的主要内容包括{{content1}}、{{content2}}和{{content3}}，都紧扣主题。最后，全体{{audience}}须{{requirement}}，以确保{{topic}}有序进行。',
            '请你{{expect}}，以便{{topic}}能够得到更为有效的处理。请仔细阅读本通知并转告相关人员。',
        ],
    },
    'inquire': {
        'rows': [
    ...
    'opinion': {
        ...
        'cn_paras': [
            ...
            '具体来说，我想谈的有三点。说实话，你分享的内容让我深有感触，尤其是{{detail}}。依我看，这体现了你细致的观察和对生活真诚的热爱。原因在于，这类记录能帮我们重新发现平凡时刻中的美好。',
