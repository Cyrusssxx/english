...
LETTERS = {
    'advice': {
        ...
        'cn_paras': [
            ...
            '至于具体措施，我的建议如下。首先，强烈建议你把{{ving}}{{topic}}落到实处，这有助于你更清楚地认识{{detail}}。此外，也建议你{{task}}，以便改善现状。最后，建议你{{task}}。唯有如此，你才能真正{{benefit}}。',
    ...
    'invite': {
        ...
        'cn_paras': [
            ...
            '至于本次活动，具体安排如下。具体而言，我想邀请你{{join}}{{topic}}，这将为你带来{{gain}}。此外，在{{topic}}期间{{task}}，你将能够{{gain}}，这对你大有裨益。最后，你的到来将使{{topic}}更有意义，也能让你{{benefit}}。',
    ...
    'thanks': {
        'rows': [
            ...
            ['p2s1#0', 'To be more specific, the main points can be arranged as follows.', '更具体地说，我想感谢以下几点。'],
        ...
        'cn_paras': [
            '希望收到此信时你一切安好。我写此信，为你的帮助向你表达诚挚的谢意。',
            '更具体地说，我想感谢以下几点。我想衷心感谢你在我逗留期间给予的热情接待。最让我感动的是你的耐心与友善，让我有宾至如归的感觉。若没有你慷慨的帮助，我不可能在{{topic}}上取得这样的进步。',
            '如果你能在{{deadline}}前{{expect}}，我将不胜感激。感谢你抽时间阅读这封信，期待你的回复。',
        ],
    },
    'congrats': {
        'rows': [
            ...
            ['p2_congrats_s2#1', 'As far as {{topic}} is concerned, your success in {{achievement}} is truly impressive and inspiring.', '就{{topic}}而言，你在{{achievement}}上的成功确实令人钦佩，也颇具鼓舞意义。'],
        ...
        'cn_paras': [
            ...
            '更具体地说，你在{{topic}}上的出色表现清楚地展现了你的{{quality}}。就{{topic}}而言，你在{{achievement}}上的成功确实令人钦佩，也颇具鼓舞意义。在很大程度上，这一成功源于你勇于{{effort}}，尤其是在应对{{topic}}的过程中。最后，{{topic}}上的这一成就必将激励你{{next step}}，助你迈向{{goal}}。',
    ...
    'apology': {
        ...
        'cn_paras': [
            '希望收到此信时你一切安好。我写此信，为{{topic}}所引起的问题向你致以诚挚的歉意。',
            '更具体地说，情况如下。在此我必须承认，我在{{topic}}上的{{fault}}已经造成了{{impact}}。由于我在{{topic}}方面{{fault}}，你不得不面对{{impact}}，这本不该发生。尽管{{cause}}在一定程度上解释了事情的起因，但主要责任仍在我。',
            '如果你能在{{deadline}}前{{expect}}，我将不胜感激。感谢你抽时间阅读这封信，期待你的回复。',
        ],
    },
    'complaint': {
        'rows': [
            ...
            ['p3#1', 'You are kindly requested to {{expect}} so that {{topic}} can be implemented more effectively.', '请你{{expect}}，以便{{topic}}能够得到更为有效的落实。'],
            ['p3#2', 'Thank you for your time and attention, and I look forward to your positive response.', '感谢你抽时间阅读这封信，期待你的回复。'],
        ],
        'cn_paras': [
            '希望收到此信时你一切安好。我写此信，正式反映近期{{topic}}出现的问题。',
            '更具体地说，情况如下。令我失望的是，上周在贵店购买的{{product}}无法正常使用。具体来说，到货仅三天就出现了{{problem}}。若你能尽快安排维修或全额退款，我将不胜感激。',
            '请你{{expect}}，以便{{topic}}能够得到更为有效的落实。感谢你抽时间阅读这封信，期待你的回复。',
        ],
    },
    'intro': {
        'rows': [
        ...
        'cn_paras': [
            '希望收到此信时你一切安好。在这封信里，我想把{{topic}}作为极佳的选择介绍给你。',
            '具体而言，{{topic}}指的是{{subject}}，其突出特点是{{feature}}。首先，它涵盖{{aspect1}}，使{{audience}}能够{{gain1}}。更具体而言，在日常生活中，我通常会{{habit1}}并且{{habit2}}，这有助于我保持{{advantage}}。总的来说，这些特点使{{topic}}成为希望{{need}}的{{audience}}的理想选择。',
            '我衷心希望你能充分利用这次机会{{outcome}}。如果你能在{{deadline}}前{{expect}}，我将不胜感激。',
        ],
    },
    'notice': {
        ...
        'cn_paras': [
            ...
            '现将本次活动的具体安排通知如下。首先，{{time}}定为{{topic}}的正式时间，届时全体{{audience}}须准时参加。此外，{{topic}}的主要内容包括{{content1}}、{{content2}}和{{content3}}，条理清晰。最后，全体{{audience}}须{{requirement}}，以确保{{topic}}有序进行。',
            '请你{{expect}}，以便{{topic}}能够得到更为有效的落实。请仔细阅读本通知并转告相关人员。',
        ],
    },
    'inquire': {
        'rows': [
        ...
        'cn_paras': [
            '希望收到此信时你一切安好。我写此信，是想与你详细探讨{{topic}}。',
            '更具体地说，我想请教以下几点。具体而言，我想知道如何更好地适应当地的生活。另外，我不确定自己的计划是否可行，很想听听你的意见。鉴于你对当地情况很熟悉，你的建议对我将十分宝贵。',
            '如果你能在{{deadline}}前{{expect}}，我将不胜感激。感谢你抽时间阅读这封信，期待你的回复。',
        ],
    },
    'opinion': {
        'rows': [
            ...
            ['p2s1#0', 'To be more specific, the main points can be arranged as follows.', '更具体地说，我想谈以下几点。'],
        ...
        'cn_paras': [
            '希望收到此信时你一切安好。非常高兴收到你的来信。借此信，我想分享我对{{topic}}的看法。',
            '更具体地说，我想谈以下几点。说实话，你分享的内容让我深有感触，尤其是{{detail}}。依我看，这体现了你细致的观察和对生活真诚的热爱。原因在于，这类记录能帮我们重新发现平凡时刻中的美好。',
            '如果你能在{{deadline}}前{{expect}}，我将不胜感激。感谢你抽时间阅读这封信，期待你的回复。',
        ],
    },
}
