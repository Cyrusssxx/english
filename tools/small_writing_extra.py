...
LETTERS = {
    ...
    'invite': {
        'rows': [
            ...
            ['p2_invite_s2#0', 'In particular, taking part in {{topic}} will grant you a valuable opportunity to {{gain}}.', '具体而言，参与{{topic}}将为你提供一个{{gain}}的宝贵契机。'],
            ['p2_invite_s3#0', 'In addition, through engaging in {{task}} during the event, you will be able to broaden your perspective considerably.', '此外，在活动期间参与{{task}}，能够极大地拓宽你的视野。'],
            ['p2_invite_s4#0', 'Finally, your distinguished presence will enrich {{topic}} and make the occasion truly memorable.', '最后，你的莅临将使{{topic}}增色不少，也会让整个活动令人难忘。'],
        ...
        'cn_paras': [
            ...
            '至于本次活动，具体安排如下。具体而言，参与{{topic}}将为你提供一个{{gain}}的宝贵契机。此外，在活动期间参与{{task}}，能够极大地拓宽你的视野。最后，你的莅临将使{{topic}}增色不少，也会让整个活动令人难忘。',
    ...
    'apology': {
        'rows': [
            ...
            ['p2_apology_s3#0', 'Although unexpected factors partly contributed to the delay, the primary accountability undoubtedly rests with me.', '尽管不可控的意外因素在一定程度上导致了延误，但主要责任毫无疑问在我。'],
        ...
        'cn_paras': [
            ...
            '为向你如实说明情况，具体缘由详陈如下。我必须坦承，关于{{topic}}出现的意外疏漏主要源自我的疏忽大意。结果导致你蒙受了{{impact}}，这完全有违我的本意。尽管不可控的意外因素在一定程度上导致了延误，但主要责任毫无疑问在我。',
    ...
    'notice': {
        'rows': [
            ...
            ['p2_notice_s4#0', 'Finally, all attendees are requested to strictly abide by {{requirement}}, thereby ensuring the orderly execution of the event.', '最后，全体参会人员须严格遵守{{requirement}}，从而确保活动有序开展。'],
            ['p3#1', 'Your active cooperation and punctual involvement are essential to making this initiative a resounding success.', '各位的积极配合与准时参与，是本次倡议取得圆满成功的关键保障。'],
        ...
        'cn_paras': [
            ...
            '各位的积极配合与准时参与，是本次倡议取得圆满成功的关键保障。请仔细查阅本通知，并将有关详情转告给所有相关人员。',
        ],
    },
    'inquire': {
        'rows': [
...
CN_FIX3 = {
    ...
    'p2_apology_s3': {0: '尽管不可控的意外因素在一定程度上导致了延误，但主要责任毫无疑问在我。'},
    ...
    'p2_invite_s3': {0: '此外，在活动期间参与{{task}}，能够极大地拓宽你的视野。'},
    ...
    'p3': {1: '各位的积极配合与准时参与，是本次倡议取得圆满成功的关键保障。'},
}
...
EN_FIX3 = {
    ...
    'p2_invite_s2': {0: 'In particular, taking part in {{topic}} will grant you a valuable opportunity to {{gain}}.'},
    'p2_invite_s3': {0: 'In addition, through engaging in {{task}} during the event, you will be able to broaden your perspective considerably.'},
    'p2_invite_s4': {0: 'Finally, your distinguished presence will enrich {{topic}} and make the occasion truly memorable.'},
    ...
    'p2_apology_s3': {0: 'Although unexpected factors partly contributed to the delay, the primary accountability undoubtedly rests with me.'},
    ...
    'p2_notice_s4': {0: 'Finally, all attendees are requested to strictly abide by {{requirement}}, thereby ensuring the orderly execution of the event.'},
    ...
    'p3': {1: 'Your active cooperation and punctual involvement are essential to making this initiative a resounding success.'},
}
