...
CORE_PAGES = [
    ...
    "js/wordnotes.js", "data/wordnotes.json", "js/phrasebook.js", "data/phrasebook.json", "js/stats.js", "data/topic_map.json", "js/writing.js", "data/writing_templates.json", "data/writing_apply.json", "data/writing_patterns.json",
